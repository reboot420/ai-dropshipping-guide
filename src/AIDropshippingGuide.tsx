...
const AIDropshippingGuide = () => {
  ...
  const ToolComparison = ({ category, tools }: ToolComparisonProps) => (
    <div className="mb-4">
  ...
  const CostItem = ({ item, cost, description }: CostItemProps) => (
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white p-6 rounded-xl shadow-sm">
      ...
      {/* 全体フロー説明セクション */}
      <Section id="overall-flow" title="事業モデル全体フロー">
        <div className="bg-gradient-to-r from-blue-50 to-green-50 p-4 rounded-lg mb-4">
          <h3 className="font-medium text-blue-800 mb-3">ビジネスプロセスの概要</h3>
          <div className="space-y-3">
            <div className="flex items-center bg-white p-3 rounded-lg shadow-sm">
              ...
              <div>
                <p className="text-gray-700"><span className="font-medium">AI技術によるデザイン生成：</span>市場分析に基づく高品質デザインの大量生成</p>
              </div>
            </div>
            <div className="flex items-center bg-white p-3 rounded-lg shadow-sm">
              <div className="flex-shrink-0 bg-blue-500 text-white w-8 h-8 rounded-full flex items-center justify-center mr-3">
              ...
              <div>
                <p className="text-gray-700"><span className="font-medium">プリントオンデマンド連携：</span>無在庫販売方式による低リスクなビジネスモデル構築</p>
              </div>
            </div>
            <div className="flex items-center bg-white p-3 rounded-lg shadow-sm">
              <div className="flex-shrink-0 bg-blue-500 text-white w-8 h-8 rounded-full flex items-center justify-center mr-3">
              ...
              <div>
                <p className="text-gray-700"><span className="font-medium">Shopify基盤構築：</span>低コストからスタートできるECインフラの整備</p>
              </div>
            </div>
            <div className="flex items-center bg-white p-3 rounded-lg shadow-sm">
              <div className="flex-shrink-0 bg-blue-500 text-white w-8 h-8 rounded-full flex items-center justify-center mr-3">
              ...
              <div>
                <p className="text-gray-700"><span className="font-medium">自動化された販売・物流：</span>APIを活用した受注から配送までの自動化プロセス</p>
              </div>
            </div>
            <div className="flex items-center bg-white p-3 rounded-lg shadow-sm">
              <div className="flex-shrink-0 bg-blue-500 text-white w-8 h-8 rounded-full flex items-center justify-center mr-3">
              ...
              <div>
                <p className="text-gray-700"><span className="font-medium">データ駆動型改善：</span>市場反応に基づく継続的な最適化と事業拡大</p>
              </div>
            </div>
          </div>
          <div className="mt-4 text-gray-700">
            <p className="font-medium text-blue-800">本事業モデルの特徴：</p>
            <ul className="list-disc pl-5 mt-1">
              <li>初期投資の最小化と迅速な市場参入</li>
              <li>AI活用による創造的差別化と商品多様性</li>
              <li>在庫リスク排除によるキャッシュフロー最適化</li>
              <li>自動化とスケーラビリティの両立</li>
            </ul>
          </div>
        </div>
      </Section>
